...
class Order(object):
    ...
    m_deltaNeutralOrderType = str()
    m_deltaNeutralAuxPrice = float()
    m_deltaNeutralConId = int()
    m_deltaNeutralSettlingFirm = str()
    m_deltaNeutralClearingAccount = str()
    m_deltaNeutralClearingIntent = str()
    ...
    #  EFP orders only
    #  SCALE ORDERS ONLY
    m_scaleInitLevelSize = int()
    m_scaleSubsLevelSize = int()
    m_scalePriceIncrement = float()
    m_scalePriceAdjustValue = float()
    m_scalePriceAdjustInterval = int()
    m_scaleProfitOffset = float()
    m_scaleAutoReset = bool()
    m_scaleInitPosition = int()
    m_scaleInitFillQty = int()
    ...
    #  IB account
    m_settlingFirm = str()
    m_clearingAccount = str()

    #  True beneficiary of the order
    m_clearingIntent = str()
    ...
    m_smartComboRoutingParams = [] #Vector()
